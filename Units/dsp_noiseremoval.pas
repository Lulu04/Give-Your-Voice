{This unit is from United Openlibraries of Sound (uos) from Fred van Stappen fiens@hotmail.com
 Original file name is uos_dsp_noiseremoval.pas}
...
begin
   ...
   FreeMem(FFFTBuffer);  FFFTBuffer := NIL;
   FreeMem(FInWaveBuffer);  FInWaveBuffer := NIL;
   FreeMem(FWindow);   FWindow := NIL;
   FreeMem(FOutOverlapBuffer); FOutOverlapBuffer := NIL;
